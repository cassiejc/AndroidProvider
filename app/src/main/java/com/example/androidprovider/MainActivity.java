...
public class MainActivity extends AppCompatActivity {
    ...
    public void getStudents(View v) {
        String URL = "content://com.example.androidprovider.MyDataProvider";
        Uri students = Uri.parse(URL);
        Cursor c = managedQuery(students,null,null,null,null);
        c.moveToFirst();
        if (c.moveToFirst()) {
            do {
                Toast.makeText(getApplicationContext(), "Nama: "+c.getString(c.getColumnIndex(MyDataProvider.NAME)),
